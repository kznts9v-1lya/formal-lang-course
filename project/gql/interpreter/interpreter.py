...
from project.gql.interpreter.visitor import GQLTreeVisitor
...
from project.gql.parser.parser import is_in_grammar, parse_to_string
...
class GQLInterpreter:
    ...
    def run_query(self, query):
        lexer = gqlLexer(InputStream(query))
